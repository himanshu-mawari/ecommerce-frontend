    ...
    <div className=" max-w-2xl md:max-w-full mx-auto pb-8">
      ...
      <div className=" px-5 md:px-8">
        <div className="flex gap-3 items-center py-4">
          ...
          <h1 className="text-md md:text-lg font-semibold">Add New Address</h1>
        </div>
        ...
        {addresses.map((address) => (
          ...
          >
            <div className="flex-1">
              <h1 className="text-lg md:text-xl font-semibold mb-1">{address.name}</h1>
              ...
              <p className="text-gray-500 mb-4 md:mt-1 geist">{address.phone}</p>
