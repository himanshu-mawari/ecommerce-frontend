...
const AdminOrderPage = () => {
  ...
  return (
    <div className="px-4 py-6 md:px-12 inter">
      <div>
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-0.5">
          Orders
        </h1>
      ...
      <div className="space-y-4">
        <div className="flex gap-2 mt-5 w-full md:max-w-md md:gap-4">
          <div className="flex-1 flex items-center gap-3 p-2 bg-white border border-gray-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-1">
            ...
            <div className="flex flex-col">
              <span className="text-[11px] md:text-xs font-medium text-gray-400 tracking-wide uppercase ">
                Pending
              </span>
        ...
        <div className="w-full flex justify-between md:justify-start gap-2 md:gap-4">
          <div className="relative flex-1 md:flex-initial">
            ...
            <input
              type="text"
              className="w-full  md:w-lg rounded-xl border border-gray-200 py-2.5 md:py-4 pl-9 pr-4 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-all text-xs md:text-sm text-gray-600 placeholder:text-gray-400"
              placeholder="Search by order Id and customer name.."
            />
          </div>

          <div
            className="flex items-center bg-indigo-700 rounded-xl px-4 py-1 md:py-2 md:h-auto gap-1 cursor-pointer hover:bg-indigo-800 active:scale-[0.98] transition-all duration-200"
          ...
          >
            ...
            <button className="text-white text-sm md:text-lg md:w-24 font-medium cursor-pointer">
              Filters
            </button>
          </div>
        </div>
            ...
            <Link to={`/admin/orders/${order.id}`}>
              <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.07)] active:bg-gray-50 transition-colors cursor-pointer hover:border-gray-400 ">
                <div className="flex justify-between items-start mb-1">
                  <div className="flex flex-col">
                    <h2 className="text-[14px] md:text-lg font-bold text-gray-900 tracking-tight">
                      ORD-{order.id}
                    </h2>
                    <div className="flex items-center gap-1.5 text-[12px] md:text-sm text-gray-500 mt-0.5">
                  ...
                  <p className="text-[15px] md:text-xl font-bold text-gray-900">
                    ₹{order.amount}
                  </p>
                </div>

                <div className="mt-3 mb-4">
                  <p className="text-[13px] md:text-lg text-gray-600 font-normal line-clamp-1 pl-2">
                    {order.itemsPreview}
                  </p>
                </div>
                ...
                <div className="flex justify-end">
                  <span
                    className={`px-3 py-1 rounded-md text-[10px] md:text-sm font-extrabold uppercase tracking-normal ${
