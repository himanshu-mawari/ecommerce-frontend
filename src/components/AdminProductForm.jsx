    ...
    <div className="inter">
      <div className="space-y-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {previews.length < 4 && (
              <label
                htmlFor="file-upload"
                className="group flex flex-col items-center justify-center aspect-square  sm:size-28 border-2 border-dashed border-gray-200 rounded-xl hover:bg-gray-50 hover:border-indigo-300 transition-all cursor-pointer"
              >
                <div className="flex flex-col items-center justify-center gap-1">
                  <HiOutlinePlus className="text-gray-400 group-hover:text-indigo-600 size-5 transition-colors" />
                  <span className="text-[10px] font-semibold text-gray-400 group-hover:text-indigo-600 transition-colors">
                    Add Image
                  </span>
                </div>
                <input
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <p className="text-xs text-gray-500 ">  Add stock quantity available for each size</p>
