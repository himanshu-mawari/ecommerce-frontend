      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex min-h-screen flex-col bg-white pt-8 text-black font-sans">
            <div className="border-b border-gray-100 pr-4 pl-6 pb-5">
              {isAuthenticated ? (
                <Link
                  to="/profile-page"
                  onClick={() => setIsOpen(false)}
                ...
                <Link
                  to="/login"
                  onClick={() => setIsOpen(false)}
                  className="flex w-full rounded-lg p-2 -mx-2 text-xl font-semibold tracking-tight text-black cursor-pointer hover:bg-gray-50 transition-all"
                >
